 ...
 */
final class Version20230703133643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service CHANGE owner_id owner_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service CHANGE owner_id owner_id INT NOT NULL');
    }
}
