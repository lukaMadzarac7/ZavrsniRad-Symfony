...
class RatingController extends AbstractController
{
    ...
    public function new(Request $request, RatingRepository $ratingRepository): Response
    {
        ...
        return $this->renderForm('admin/rating/new.html.twig', [
            'rating' => $rating,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_rating_show', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    public function edit(Request $request, Rating $rating, RatingRepository $ratingRepository): Response
    {
        ...
        return $this->renderForm('admin/rating/edit.html.twig', [
            'rating' => $rating,
            'form' => $form,
        ]);
    }
