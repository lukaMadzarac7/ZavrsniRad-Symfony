...
class CityController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_city_show', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/{id}/edit', name: 'app_city_edit', methods: ['GET', 'POST'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/{id}', name: 'app_city_delete', methods: ['POST'], requirements: ['id' => '\d+'])]
