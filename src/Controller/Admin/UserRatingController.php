...
class UserRatingController extends AbstractController
{
    ...
    {
        return $this->render('admin/user_rating/index.html.twig', [
    ...
    public function new(Request $request, UserRatingRepository $userRatingRepository): Response
    {
        ...
        return $this->renderForm('admin/user_rating/new.html.twig', [
            'user_rating' => $userRating,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_user_rating_show', methods: ['GET'], requirements: ['id' => '\d+'])]
    public function show(UserRating $userRating): Response
    {
        return $this->render('admin/user_rating/show.html.twig', [
            'user_rating' => $userRating,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_user_rating_edit', methods: ['GET', 'POST'], requirements: ['id' => '\d+'])]
    public function edit(Request $request, UserRating $userRating, UserRatingRepository $userRatingRepository): Response
    {
        ...
        return $this->renderForm('admin/user_rating/edit.html.twig', [
            'user_rating' => $userRating,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_user_rating_delete', methods: ['POST'], requirements: ['id' => '\d+'])]
